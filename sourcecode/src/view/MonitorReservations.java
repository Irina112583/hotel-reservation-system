...
public class MonitorReservations extends javax.swing.JFrame {
    ...
    private void initRoomsTMembers(Hotel hotel){
        ...
        row = hotel.allRooms.size();
        
        roomsData = new Object[row][column];
        
        
        for (int i = 0; i < hotel.allRooms.size(); i++) {
        	...
        	if(availability == true) {
        		availabilityStatus = "Available for resevration";
        	} else {
        		availabilityStatus = "Not available due to maintanence";
        	}
